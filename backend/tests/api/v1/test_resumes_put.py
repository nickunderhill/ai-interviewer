...
@pytest.mark.asyncio
async def test_update_resume_success(async_client: AsyncClient, test_user: User, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_update_resume_timestamp_changes(async_client: AsyncClient, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_update_resume_not_found_returns_404(async_client: AsyncClient, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_update_resume_empty_content_returns_422(async_client: AsyncClient, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_update_resume_content_too_long_returns_422(async_client: AsyncClient, auth_headers: dict):
